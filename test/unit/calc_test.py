...
class TestCalculate(unittest.TestCase):
    ...
    def test_divide_by_zero_method(self):
        ...
        self.assertRaises(TypeError, self.calc.divide, 2, -0)
        self.assertRaises(TypeError, self.calc.divide, 10, 0.0)
        self.assertRaises(TypeError, self.calc.divide, 2, -0.0)
        self.assertRaises(TypeError, self.calc.divide, 2, "0")
        self.assertRaises(TypeError, self.calc.divide, 2, "-0")
        self.assertRaises(TypeError, self.calc.divide, 2, "0.0")
        self.assertRaises(TypeError, self.calc.divide, 2, "-0.0")
    ...
    def test_divide_negative_numbers_method_returns_correct_result(self):
        self.assertEqual(1, self.calc.divide(-2, -2))
        self.assertEqual(-1.5, self.calc.divide(-3, 2))
        self.assertEqual(-1.5, self.calc.divide(3, -2))
        self.assertEqual(0, self.calc.divide(0, -2))
